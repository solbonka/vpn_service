...
<head>
    ...
    <title>Инструкция по добавлению ключ от VPN в приложение «Happ» на Android</title>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
                ...
                <div class="text-center mb-4">
                    <h1 class="h2 mb-2">Как добавить ключ от VPN в приложение «Happ» на Android</h1>
                </div>
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <div class="w-100">
                            <h3 class="h6 fw-bold mb-2">Чтобы добавить ключ,
                                вам нужно установить приложение «Happ» из GooglePlay
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <div class="w-100">
                            <h3 class="h6 fw-bold mb-2">
                                Перейдите в приложение Happ, нажмите "Из буфера",
                                теперь для включение VPN достаточно нажать на круглую кнопку включения и VPN
                                включится.
                                <img class="img-fluid" src="{{asset('/vpn/images/android/happ/happ.jpg')}}" alt=""/>
                            </h3>
                            <p class=" mb-2">
