...
<head>
    ...
    <title>Инструкция по установке приложение «Happ» на Android</title>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
                ...
                <div class="text-center mb-4">
                    <h1 class="h2 mb-2">Как установить приложение «Happ» на Android</h1>
                </div>
                ...
                <div class="list-group-item border-0 px-0">
                    <div class="d-flex gap-2">
                        ...
                        <div class="w-100">
                            <h3 class="h6 fw-bold mb-2">Установите приложение «Happ» из Google Play
                            ...
                            <div class="sub-step">
                                ...
                                <div class="d-flex gap-2 mb-3">
                                    ...
                                    <div>
                                        <p class="mb-3 text-muted small">
                                            Введите «Happ» в строку поиска и нажмите поиск.
                                        </p>
                                        <img class="img-fluid" src="{{asset('/vpn/images/android/happ/happ3.jpg')}}" alt="Поиск v2RayTun"/>
                                    </div>
                                </div>
                                <div class="d-flex gap-2 mb-3">
                                    ...
                                    <div>
                                        <p class="mb-3 text-muted small">
                                            В результатах поиска найдите «Happ» и нажмите «Установить».
                                        </p>
                                        <img class="img-fluid" src="{{asset('/vpn/images/android/happ/happ4.jpg')}}" alt="Установка"/>
                                    </div>
                                </div>
                                <div class="d-flex gap-2 mb-3">
                                    ...
                                    <div>
                                        ...
                                        <img class="img-fluid" src="{{asset('/vpn/images/android/happ/happ5.jpg')}}" alt="Процесс установки"/>
                                    </div>
                                </div>
                                <div class="d-flex gap-2 mb-3">
                                    ...
                                    <div>
                                        ...
                                        <img class="img-fluid" src="{{asset('/vpn/images/android/happ/happ6.jpg')}}" alt="Успешная установка"/>
                                    </div>
                                </div>
                            </div>
                        </div>
