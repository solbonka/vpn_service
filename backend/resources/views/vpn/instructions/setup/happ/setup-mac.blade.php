...
<head>
    ...
    <title>Инструкция по установке приложения «Happ» на Mac</title>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
                <div class="text-center mb-4">
                    <h1 class="h2 mb-2">Установка приложения «Happ» на Mac</h1>
                </div>
                <div class="list-group-item border-0 px-0">
                    <div class="d-flex gap-2 mb-4">
                        <div class="badge bg-primary rounded-pill align-self-start"></div>
                        <div class="w-100">
                            <h3 class="h6 fw-bold mb-4">Выполните все шаги для установки приложения Happ.</h3>
                                    ...
                                    <div class="w-100">
                                        <h3 class="h6 fw-bold mb-2">
                                            ...
                                            <a href="https://apps.apple.com/ru/app/happ-proxy-utility-plus/id6746188973"
                                               target="_blank" class="text-decoration-underline">страницу</a> в AppStore и установите Happ.
                                        </h3>
                                        <img class="img-fluid mb-2" src="{{asset('/vpn/images/ios/setup/happ/happ1.jpg')}}" alt="Установочный файл"/>
                            ...
                            <div class="list-group-item border-0 px-0 mb-4">
                                <div class="d-flex gap-2">
                                    ...
                                    <div class="w-100">
                                        ...
                                        <img class="img-fluid" src="{{asset('/vpn/images/ios/setup/happ/happ2.jpg')}}" alt="Запущенное приложение"/>
                                    </div>
                                </div>
                            </div>
