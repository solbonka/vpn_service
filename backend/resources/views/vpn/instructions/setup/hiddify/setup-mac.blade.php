...
<head>
    ...
    <title>Инструкция по установке приложения «Hiddify» на Mac</title>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
                <div class="text-center mb-4">
                    <h1 class="h2 mb-2">Установка приложения «Hiddify» на Mac</h1>
                </div>
                <div class="list-group-item border-0 px-0">
                    <div class="d-flex gap-2 mb-4">
                        <div class="badge bg-primary rounded-pill align-self-start"></div>
                        <div class="w-100">
                            <h3 class="h6 fw-bold mb-4">Выполните все шаги для установки приложения Hiddify.</h3>
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <div class="w-100">
                                        <h3 class="h6 fw-bold mb-2">
                                            Откройте
                                            <a href="https://apps.apple.com/ru/app/hiddify-proxy-vpn/id6596777532"
                                               target="_blank" class="text-decoration-underline">страницу</a> в AppStore и установите Hiddify.
                                        </h3>
                                        <img class="img-fluid mb-2" src="{{asset('/vpn/images/ios/setup/hiddify.jpg')}}" alt="Установочный файл"/>
